...
namespace UI
{
    public partial class UiForm : BaseForm
    {
        ...
        public UiForm(string[] args): base(args, FdModule.UI)
        {
            ...
            ChangeObjEnableAccordingPermission();
        ...
        private void InitEventController()
        {
            ...
            {
                g_eventController = new UIController();
            }
        ...
        protected override void ModuleInit()
        {
            ...
            KIniFile ini = new KIniFile(CommonData.HIRATA.CommonStaticData.g_UiModuleSystemIniFile);
            //check eq data at local mode.
            cv_monitorMount = int.Parse((ini.ReadString("Monitor", "Number", "1").Trim()));
        ...
        private void IniMonitorForm()
        {
            ...
            for (int i = 0; i < cv_monitorMount; i++)
            {
                IfMonitor tmp = new IfMonitor();
                int redvalue = 190 + 5 * i;
                if(i%2 == 1)
                    redvalue = 192;
                else
                    redvalue = 170;
                tmp.setGroupBoxColor(redvalue , 192, 255);
                //tmp.Dock = DockStyle.Left;
                cv_MonitorForm.Controls[0].Controls.Add(tmp);
                w = tmp.Width;
                h = tmp.Height;
            }
...
*/
        ...
        protected override void initLog()
        {
            ...
            if (cv_BcMsgLog == null)
            {
                ...
                cv_BcMsgLog.LoadFromIni(CommonData.HIRATA.CommonStaticData.g_UiModuleLogsIniFile, "BCMSG");
                cv_BcMsgLog.LogFileName = enviPath + "\\BcMsg.log";
                cv_BcMsgLog.SaveToIni(CommonData.HIRATA.CommonStaticData.g_UiModuleLogsIniFile, "BCMSG");
...
cb_IoFfu
        ...
        private void ChangeObjEnableAccordingPermission()
        {
            WriteLog(LogLevelType.NormalFunctionInOut, CommonData.HIRATA.CommonStaticData.__FUN(), CommonData.HIRATA.FunInOut.Enter);
            AccountItem tmp = null;
        ...
        {
            List<int> tmp = new List<int>();
            if ((cv_PermissionSetting.dataGridView1.Rows[i].Cells[1] as DataGridViewCheckBoxCell).Value.ToString() == "T")
            {
                tmp.Add(1);
            ...
            if ((cv_PermissionSetting.dataGridView1.Rows[i].Cells[2] as DataGridViewCheckBoxCell).Value.ToString() == "T")
            {
                tmp.Add(2);
            ...
            if ((cv_PermissionSetting.dataGridView1.Rows[i].Cells[3] as DataGridViewCheckBoxCell).Value.ToString() == "T")
            {
                tmp.Add(3);
            ...
            if ((cv_PermissionSetting.dataGridView1.Rows[i].Cells[4] as DataGridViewCheckBoxCell).Value.ToString() == "T")
            {
                tmp.Add(4);
            ...
            if ((cv_PermissionSetting.dataGridView1.Rows[i].Cells[5] as DataGridViewCheckBoxCell).Value.ToString() == "T")
            {
                tmp.Add(5);
            ...
            if ((cv_PermissionSetting.dataGridView1.Rows[i].Cells[6] as DataGridViewCheckBoxCell).Value.ToString() == "T")
            {
                tmp.Add(6);
