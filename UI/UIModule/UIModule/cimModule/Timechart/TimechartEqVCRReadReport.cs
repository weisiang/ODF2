    ...
    class TimechartEqVCRReadReport : TimechartControllerBase.TimechartInstanceBase
    {
        ...
        protected override bool ProcessJob(object m_obj)
        {
            ...
            try
            {
                ...
                cv_MemoryIoClient.SetBinaryLengthData(0x467E, tmp, 23, false);
        ...
        void OnEnter_WaitTm(int m_StepId)
        {
            ...
            try
            {
                uint index = (uint)cv_MemoryIoClient.GetPortValue(0x4695);
                if (index == 0xffff)
                {
                    index = 1;
                }
                ...
                cv_MemoryIoClient.SetPortValue(0x4695, (int)index);
