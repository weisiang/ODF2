    ...
    class TimechartEqSendReport : TimechartControllerBase.TimechartInstanceBase
    {
        ...
        protected override bool ProcessJob(object m_obj)
        {
            ...
            try
            {
                ...
                cv_MemoryIoClient.SetBinaryLengthData(0x3489, tmp, 13, false);

                int tmp_slot = cv_MemoryIoClient.GetPortValue(0x3489) & 0xff;
                string tmp2 = cv_MemoryIoClient.GetBinaryLengthData(0x348C, 10, false);
        ...
        void OnEnter_WaitTm(int m_StepId)
        {
            ...
            try
            {
                uint index = (uint)cv_MemoryIoClient.GetPortValue(0x3496);
                if (index == 0xffff)
                {
                    index = 1;
                }
                ...
                cv_MemoryIoClient.SetPortValue(0x3496, (int)index);
