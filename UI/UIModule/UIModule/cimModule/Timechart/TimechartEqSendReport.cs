...
namespace CIM
{
    class TimechartEqSendReport : TimechartControllerBase.TimechartInstanceBase
    {
        ...
        public static int STEP_ID_TriggerSendIndex = 1;
        public static int STEP_ID_WaitInterval = 3;
        public static int STEP_ID_WaitTm = 2;

        public TimechartEqSendReport(TimechartControllerBase m_TimechartController, int m_TimechartId, Dictionary<string, int> m_VarPortMap)
            : base(m_TimechartController, m_TimechartId, m_VarPortMap)
        {

            AssignEnterStepEventFunction(STEP_ID_TriggerSendIndex, OnEnter_TriggerSendIndex);
        ...
        protected override bool ProcessJob(object m_obj)
        {
            ...
            try
            {
                string log = "[Process][TimechartEqSendReport ProcessJob]\n";
                ...
                value = (((int)obj.PGlassData.PWorkOrderNo) << 8) + (int)obj.PGlassData.cv_WorkSlot;
                ...
                cv_MemoryIoClient.SetBinaryLengthData(0x4289, tmp, 13, false);

                int tmp_slot = cv_MemoryIoClient.GetPortValue(0x4289) & 0xff;
                string tmp2 = cv_MemoryIoClient.GetBinaryLengthData(0x428C, 10, false);
        ...
        void OnEnter_WaitTm(int m_StepId)
        {
            ...
            try
            {
                uint index = (uint)cv_MemoryIoClient.GetPortValue(0x4296);
                if (index == 0xffff)
                {
                    index = 1;
                }
                ...
                cv_MemoryIoClient.SetPortValue(0x4296, (int)index);
        ...
        void OnEnter_TriggerSendIndex(int m_StepId)
        {
            CimModule.WriteLog(CommonData.HIRATA.LogLevelType.NormalFunctionInOut, this.GetType().Name + "." + System.Reflection.MethodBase.GetCurrentMethod().Name, CommonData.HIRATA.FunInOut.Enter);
            CimModule.WriteLog(CommonData.HIRATA.LogLevelType.NormalFunctionInOut, this.GetType().Name + "." + System.Reflection.MethodBase.GetCurrentMethod().Name, CommonData.HIRATA.FunInOut.Leave);
        }
